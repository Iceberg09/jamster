                    ...
                    <Row>
                        <Col xl={6} lg={6} md={6} sm={12} xs={12}>
                            ...
                            <DropdownButton className="mt-2 mr-1" style={{'width': '205px'}} id="dropdown-basic-button" title="Add Instrument" size="lg" onSelect={this.InstrumentAdd}>
                                ...
                                <DropdownItem eventKey="Bass">Bass</DropdownItem>
                                <DropdownItem eventKey="Drums">Drums</DropdownItem>
                                <DropdownItem eventKey="Guitar">Guitar</DropdownItem>
                                ...
                                <DropdownItem eventKey="Keyboard">Keyboard</DropdownItem>
                                ...
                                <DropdownItem eventKey="Vocals">Vocals</DropdownItem>
                                </DropdownButton>
